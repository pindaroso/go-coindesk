...
type State struct {
	...
	BidDelta  []coindesk.Order `json:"b"`
	AskDelta  []coindesk.Order `json:"a"`
}
...
func (o *OrderBook) ProcessBids(bids []coindesk.Order) {
...
func (o *OrderBook) ProcessAsks(asks []coindesk.Order) {
...
func main() {
	...
	symbol := "ethbtc"
	address := fmt.Sprintf("wss://stream.coindesk.com:9443/ws/%s@depth", symbol)
